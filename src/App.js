...
<button id="toggleAPI" onclick="window.configStore.toggleAPI()">${
  useCompositionAPI.value ? "Composition" : "Options"
}</button>
...
toggleAPI.addEventListener("click", () => {
  toggleAPI.innerHTML = configStore.useCompositionAPI.value
    ? "Composition"
    : "Options";
